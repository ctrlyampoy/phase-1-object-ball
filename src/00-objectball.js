function gameObject() {
  ...
  // Function to return the number of points scored for a given player
  ...
  // Function to return the shoe size for a given player
  ...
  // Function to return an array of team colors for a given team name
  ...
  // Function to return an array of jersey numbers for a given team name
  ...
  // Function to return the stats for a given player
  ...
  function bigShoeRebounds() {
    ...
    return game[Object.keys(game).find(team => game[team].players[playerWithLargestShoe])].players[playerWithLargestShoe].rebounds;
  }
  
  // Testing the functions
  console.log(numPointsScored("Brook Lopez")); // Output: 17
  ...
  console.log(bigShoeRebounds()); // Output: 12 (Rebounds of the player with the largest shoe size)
